...
export default function AboutPage() {
  return (
    <main
      ...
      "
    >
      <div className="flex w-full max-w-6xl mx-auto mt-16 mb-16 justify-center items-center">
        <div className="relative w-full max-w-3xl h-screen p-8">
          <Image
          ...
          />
          <div className="absolute inset-0 p-8 flex flex-col justify-start h-full overflow-y-auto">
            <div className="bg-black bg-opacity-70 p-8 rounded">
              ...
              <p className="text-base">
                ...
                formative years. At the age of 10, he moved to the United States by
                way of Hartford, Connecticut where he felt an absence of music
                compared to his time in Jamaica. To fill this void, he started
                playing in drum lines and singing in choir in middle school where he
                took a lot of solos when no one else wanted to. This was the start
                of his experience in the limelight.
                <br />
                <br />
                ...
                20, he started releasing music under the name, Marlon Orlando, a nod
                to Kendrick Lamar and Isaiah Rashad. Eventually, Marlon decided to
                drop out to pursue music. He eventually moved to Providence, RI and
                played some of his first shows at Brown University. To further his
                artistry, Marlon is now based in Brooklyn, NY where also began
                DJing.
                <br />
                <br />
                ...
                legends like Bob Marley who was able to speak to those who are young
                or old, Kendrick Lamar who can convey complex topics through his
                music, and Drake who can put words to feelings that everyone has
                felt. His creative inspiration extends beyond music to include
